...
\usepackage[font={small},labelfont={sf,sl},format=plain,indention=.5cm]{caption}
...
applicable to microRNA target prediction. Limitations and refinements of
the method are discussed. The importance of an integrative approach is highlighted.
...
käsitellään. Erilaista dataa yhdistävän lähestymistavan tärkeyttä korostetaan.
