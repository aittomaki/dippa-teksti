...
$x$               & Explanatory variables or vector of microRNA expression values \\
$X$               & Matrix of microRNA expression values \\
$y$               & Outcome variable or vector of protein expression values \\
$y \tilde N(.)$   & Random variable $y$ has probability distribution $N(.)$ \\
$z$               & Vector of mRNA expression values
\end{tabular}
...
\section{Table of model properties\label{appendixA}}
