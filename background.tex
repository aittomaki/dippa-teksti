...
\citep{T7}. The transcribed primary miRNA molecule, pri-miRNA, contains a
...
\citep{T6}. The pri-miRNA is cut by the endonuclease Drosha (also known as
...
which is a member of the nuclear transport receptor family \citep{T8}.
