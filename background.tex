...
interactions are unknown, even for validated interaction pairs. Uncovering
...
have a family member or relative with breast cancer \textbf{VIITE?}. This is
...
The most well-known heriditary forms of breast cancer are those related to a
tumor predisposition syndrome caused by mutations in the breast cancer 1
(BRCA1) or BRCA2 genes. \textbf{Vähän lisää tästä, myös tuumoreissa usein
somaattisena mutaationa(?).}
