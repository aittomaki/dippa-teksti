...
(nucleotides 2-7) appears to be the primary determinant in target mRNA
...
even not all seed matches are functional target sites \citep{Grimson2007}.
...
\citep{Akhtar2016}. A few examples of popular target site prediction tools
are given below.

ESIMERKKEJÄ ALGORITMEISTÄ
...
novel sites will be discarded. Nonetheless, it is perhaps the most used
additional criterion. Additionally, methods requiring some degree of seed region pairing
