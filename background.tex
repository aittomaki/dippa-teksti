...
train... One tool, uses a semisupervised method, where a very strict
...
\begin{table}
  ...
  \begin{tabular}{ lllp{6cm} }
    ...
    Engelmann & \citep{Engelmann2012} & Least-angle regression & None or filter & \\
...
Both problems can be solved using regularized regression.

\paragraph{Regularized regression}
Most commonly In regularized least squares a penalty term is
...
Several methods use the 1-norm ($R(\mathbf{w_j}) = ||\mathbf{w_j}||_1$)
...
\citep{vanIterson2013}, and approeaches similar to gene-set enrichment
