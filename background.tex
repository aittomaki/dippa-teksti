...
identify miRNA targets. This problem is worsened by a large multiple-
...
Bayesian analysis has previously been applied to miRNA 
target prediction. One of the earliest tools to use expression
data for target prediction was GenMir++. It's latest
version, GenMir3, now integrates sequence-based features
into the algorithm, although the authors state that
this did not affect the results to a significant extent.

Stingo et al have proposed a Bayesian method based on
