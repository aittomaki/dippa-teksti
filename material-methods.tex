...
gene were downloaded from miRWalk \citep{miRWalk}. Genes for which there were no validated
miRNA interactors were assumed to have zero. The mean number of miRNA
