...
presented here, each gene was considered separately, and the same expression
values were used for all family members.
...
\]
The LPD's from each cross-validation fold were pooled and a mean over the full set of data
