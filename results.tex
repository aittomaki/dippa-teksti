...
The results of performed analyses are presented as follows. First, short
...
presented. Finally, the performance of projection prediction and lasso regression
...
distributions is shown in Appendix \ref{fig:model-size-distribution}).
